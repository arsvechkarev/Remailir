...
class TheToolbar @JvmOverloads constructor(
  ...
  init {
    ...
    try {
      this.setBackgroundIfNeeded(typedArray, R.styleable.TheToolbar_backgroundColor)
      imageBack.setBackgroundIfNeeded(typedArray, R.styleable.TheToolbar_imageBackColor)
