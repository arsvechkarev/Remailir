...
import com.arsvechkarev.chat.di.DaggerMessagingComponent
import com.arsvechkarev.chat.list.MessagingAdapter
import com.arsvechkarev.chat.list.toDisplayableItems
import com.arsvechkarev.chat.presentation.MessagingState.Failure
import com.arsvechkarev.chat.presentation.MessagingState.MessagingList
...
class MessagingFragment : BaseFragment() {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    DaggerMessagingComponent.create().inject(this)
