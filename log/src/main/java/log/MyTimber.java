...
public final class MyTimber {
   ...
   */
  public static void log(int priority, Throwable t, @NonNls String message,
      Object... args) {
  ...
  /**
   * A view into Timber's planted trees as a tree itself. This can be used for injecting a
   * logger instance rather than using static methods or to facilitate testing.
   */
  @NotNull
  ...
  /**
   * A {@link Tree} that delegates to all planted trees in the {@linkplain #FOREST
   * forest}.
   */
  ...
  public static abstract class Tree {
    ...
    /**
     * Write a log message to its destination. Called for all level-specific methods by
     * default.
     *
     ...
     * will not be.
     */
    protected abstract void log(int priority, @Nullable String tag,
  ...
  public static class DebugTree extends Tree {
     ...
     * {@link Log#println(int, String, String) Log.println()} or {@link Log#wtf(String,
     * String) Log.wtf()} for logging.
     *
     * {@inheritDoc}
     */
    @Override
